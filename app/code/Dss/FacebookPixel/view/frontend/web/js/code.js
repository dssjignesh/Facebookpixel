...
define([
    ...
    return function (config) {
        ...
        window.fb = function() {
            ...
            } else if ($('.dss-subscribe-email').text()) {
                fbq('init', id, {
                    em : $('.dss-subscribe-email').text()
                });
            } else {
                fbq('init', id);
            }

            if ($('.dss-subscribe-email').text()) {
                fbq('track', 'Subscribe', {
                    id : $('.dss-subscribe-id').text()
                });

                $('.dss-subscribe-id').text('');
                $('.dss-subscribe-email').text('');
            }
